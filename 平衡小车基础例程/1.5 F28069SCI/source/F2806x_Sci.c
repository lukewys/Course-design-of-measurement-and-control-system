...
//	GpioCtrlRegs.GPAPUD.bit.GPIO11 = 0;    // Enable pull-up for GPIO11 (SCIRXDB)
	GpioCtrlRegs.GPAPUD.bit.GPIO15 = 0;    // 使能GPIO15 (SCIRXDB)内部上拉功能
...
//	GpioCtrlRegs.GPBPUD.bit.GPIO40 = 0;	   // Enable pull-up for GPIO40 (SCITXDB)
	GpioCtrlRegs.GPBPUD.bit.GPIO58 = 0;	   // 使能 GPIO58 (SCITXDB) 内部上拉功能
...
//	GpioCtrlRegs.GPAMUX1.bit.GPIO11 = 2;   // Configure GPIO11 for SCIRXDB operation
	GpioCtrlRegs.GPAMUX1.bit.GPIO15 = 2;   // 配置为SCIRXDB功能
...
//	GpioCtrlRegs.GPBMUX1.bit.GPIO40 = 2;   // Configure GPIO40 for SCITXDB operation
	GpioCtrlRegs.GPBMUX2.bit.GPIO58 = 2;   // 配置为 SCITXDB 功能
